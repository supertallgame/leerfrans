...
const englishChapter4Words: VocabItem[] = [
  // Section A - Sport
  { french: "athlete", dutch: "atleet; sporter", section: "A" },
  { french: "to beat", dutch: "verslaan", section: "A" },
  { french: "champion", dutch: "kampioen", section: "A" },
  { french: "court", dutch: "speelveld (afgesloten ruimte)", section: "A" },
  { french: "field", dutch: "speelveld (open ruimte)", section: "A" },
  { french: "goalie", dutch: "doelman; doelvrouw", section: "A" },
  { french: "gymnastics", dutch: "turnen", section: "A" },
  { french: "ice rink", dutch: "ijsbaan", section: "A" },
  { french: "(to be) in shape", dutch: "fit; in vorm zijn", section: "A" },
  { french: "martial arts", dutch: "vechtsport", section: "A" },
  { french: "match (UK); game (US)", dutch: "wedstrijd", section: "A" },
  { french: "player", dutch: "speler", section: "A" },
  { french: "referee", dutch: "scheidsrechter", section: "A" },
  { french: "rule", dutch: "(spel)regel", section: "A" },
  { french: "to skate", dutch: "schaatsen", section: "A" },
  { french: "to work out", dutch: "sporten; fitnessen", section: "A" },
  { french: "goal", dutch: "doel; doelpunt", section: "A" },
  // Section B - Sport 2
  { french: "atletiek", dutch: "athletics; track and field (US)", section: "B" },
  { french: "bal", dutch: "ball", section: "B" },
  { french: "basketball", dutch: "basketball", section: "B" },
  { french: "gooien", dutch: "to throw", section: "B" },
  { french: "helm", dutch: "helmet", section: "B" },
  { french: "honkbal", dutch: "baseball", section: "B" },
  { french: "knuppel", dutch: "bat", section: "B" },
  { french: "racket", dutch: "racket", section: "B" },
  { french: "schoppen", dutch: "to kick", section: "B" },
  { french: "scoren", dutch: "to score", section: "B" },
  { french: "slaan", dutch: "to hit", section: "B" },
  { french: "stick", dutch: "stick", section: "B" },
  { french: "(tafel)tennis", dutch: "(table) tennis", section: "B" },
  { french: "vangen", dutch: "to catch", section: "B" },
  { french: "veldhockey; ijshockey", dutch: "field hockey; (ice) hockey", section: "B" },
  { french: "verliezen", dutch: "to lose", section: "B" },
  { french: "volleybal", dutch: "volleyball", section: "B" },
  { french: "winnen", dutch: "to win", section: "B" },
  // Section C - Werk
  { french: "company", dutch: "bedrijf", section: "C" },
  { french: "customer", dutch: "klant", section: "C" },
  { french: "employee", dutch: "werknemer", section: "C" },
  { french: "employer", dutch: "werkgever", section: "C" },
  { french: "job application (form)", dutch: "sollicitatie(formulier)", section: "C" },
  { french: "job interview", dutch: "sollicitatiegesprek", section: "C" },
  { french: "office", dutch: "kantoor", section: "C" },
  { french: "to quit", dutch: "ontslag nemen", section: "C" },
  { french: "volunteer", dutch: "vrijwilliger", section: "C" },
  // Section D - Beroepen
  { french: "advocaat", dutch: "lawyer", section: "D" },
  { french: "baas", dutch: "boss", section: "D" },
  { french: "brandweerman/-vrouw", dutch: "fire-fighter", section: "D" },
  { french: "(vrachtwagen-/bus-/taxi-)chauffeur", dutch: "(truck, bus, taxi) driver", section: "D" },
  { french: "chef-kok", dutch: "chef", section: "D" },
  { french: "dierenarts", dutch: "vet", section: "D" },
  { french: "dokter", dutch: "doctor", section: "D" },
  { french: "ingenieur", dutch: "engineer", section: "D" },
  { french: "kapper", dutch: "hairdresser", section: "D" },
  { french: "krantenbezorger", dutch: "newspaper carrier", section: "D" },
  { french: "oppas", dutch: "babysitter", section: "D" },
  { french: "piloot", dutch: "pilot", section: "D" },
  { french: "politieagent", dutch: "police officer", section: "D" },
  { french: "tandarts", dutch: "dentist", section: "D" },
  { french: "vakkenvuller", dutch: "shelf stocker", section: "D" },
  { french: "verpleegkundige", dutch: "nurse", section: "D" },
  { french: "winkelassistent", dutch: "shop assistant", section: "D" },
  // Section E - Geld 1
  { french: "amount", dutch: "hoeveelheid; bedrag", section: "E" },
  { french: "bank account", dutch: "bankrekening", section: "E" },
  { french: "bank machine (UK); ATM (US)", dutch: "geldautomaat", section: "E" },
  { french: "banknote (UK); bill (US)", dutch: "bankbiljet", section: "E" },
  { french: "to borrow", dutch: "lenen (van)", section: "E" },
  { french: "(to be) broke", dutch: "blut", section: "E" },
  { french: "debit card", dutch: "bankpas", section: "E" },
  { french: "coin", dutch: "munt", section: "E" },
  { french: "dime (US)", dutch: "dubbeltje", section: "E" },
  { french: "discount", dutch: "korting", section: "E" },
  { french: "to lend", dutch: "uitlenen", section: "E" },
  { french: "nickel (US)", dutch: "munt van vijf cent", section: "E" },
  { french: "to pay back", dutch: "terugbetalen", section: "E" },
  { french: "piggy bank", dutch: "spaarvarken", section: "E" },
  { french: "receipt", dutch: "kassabon", section: "E" },
  { french: "to sell", dutch: "verkopen", section: "E" },
  { french: "to withdraw", dutch: "opnemen (geld)", section: "E" },
  // Section F - Geld 2
  { french: "arm", dutch: "poor", section: "F" },
  { french: "betalen (voor)", dutch: "to pay (for)", section: "F" },
  { french: "cent", dutch: "penny; cent (US)", section: "F" },
  { french: "centen (UK)", dutch: "pence", section: "F" },
  { french: "contant geld", dutch: "cash", section: "F" },
  { french: "gratis", dutch: "free", section: "F" },
  { french: "inkomen", dutch: "income", section: "F" },
  { french: "kosten", dutch: "to cost", section: "F" },
  { french: "pond", dutch: "pound", section: "F" },
  { french: "portemonnee", dutch: "wallet; purse (UK)", section: "F" },
  { french: "prijs", dutch: "price; cost", section: "F" },
  { french: "rijk", dutch: "rich", section: "F" },
  { french: "salaris", dutch: "salary", section: "F" },
  { french: "sparen", dutch: "to save (up for)", section: "F" },
  { french: "uitgeven", dutch: "to spend", section: "F" },
  { french: "wisselgeld; muntgeld", dutch: "change", section: "F" },
  { french: "zakgeld", dutch: "pocket money (UK); allowance (US)", section: "F" },
  // Section G - Vrije tijd 1
  { french: "coffee shop", dutch: "café", section: "G" },
  { french: "entrance fee", dutch: "toegangsprijs", section: "G" },
  { french: "to get a bite to eat", dutch: "een hapje eten", section: "G" },
  { french: "(to be) grounded", dutch: "huisarrest (hebben)", section: "G" },
  { french: "to have a good time", dutch: "plezier hebben; zich vermaken", section: "G" },
  { french: "ice cream parlour", dutch: "ijssalon", section: "G" },
  { french: "play", dutch: "toneelstuk", section: "G" },
  { french: "ride", dutch: "attractie", section: "G" },
  { french: "roller coaster", dutch: "achtbaan", section: "G" },
  { french: "zoo", dutch: "dierentuin", section: "G" },
  // Section H - Vrije tijd 2
  { french: "afspreken", dutch: "to meet (up)", section: "H" },
  { french: "barbecue", dutch: "barbecue", section: "H" },
  { french: "bowlen", dutch: "bowling", section: "H" },
  { french: "genieten", dutch: "to enjoy (oneself)", section: "H" },
  { french: "kermis", dutch: "funfair (UK); carnival (US)", section: "H" },
  { french: "logeerpartij", dutch: "sleepover", section: "H" },
  { french: "picknick", dutch: "picnic", section: "H" },
  { french: "plannen hebben", dutch: "to have plans", section: "H" },
  { french: "plezier", dutch: "fun", section: "H" },
  { french: "pretpark", dutch: "amusement park", section: "H" },
  { french: "restaurant", dutch: "restaurant", section: "H" },
  { french: "strand", dutch: "beach", section: "H" },
  { french: "thuisblijven", dutch: "to stay in", section: "H" },
  { french: "tijd doorbrengen met", dutch: "to hang out with", section: "H" },
  { french: "uitgaan (met); daten", dutch: "to go out (with)", section: "H" },
];
