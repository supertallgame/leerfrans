...
const mp = {
  nl: {
    ...
    subtitle: "Speel tegen je vrienden!",
    yourName: "Jouw naam",
    newGame: "🎮 Nieuw spel starten",
    or: "of",
    enterCode: "Code invoeren (bv. ABC12)",
    join: "🚀 Deelnemen",
    randomJoin: "🎲 Ga willekeurige kamer in",
    searching: "Zoeken...",
    searchPublic: "Openbare kamers zoeken",
    searchPlaceholder: "Zoek op host of code...",
    refresh: "🔄 Vernieuwen",
    noPublicRooms: "Geen openbare kamers gevonden",
    chooseMode: "Kies een modus",
    howToPlay: "Hoe wil je spelen?",
    normal: "⚡ Normaal",
    normalDesc: "De host bepaalt het tempo en gaat door naar de volgende vraag",
    kahoot: "🎯 Kahoot-stijl",
    kahootDesc: "Iedereen moet antwoorden voordat de volgende vraag komt",
    soloOrTeams: "Solo of Teams?",
    chooseHow: "Kies hoe je wilt spelen",
    privateRoom: "Privékamer",
    publicRoom: "Openbare kamer",
    privateDesc: "Alleen toegankelijk met code",
    publicDesc: "Iedereen kan joinen of zoeken",
    solo: "👤 Iedereen voor zich",
    soloDesc: "Elke speler speelt individueel",
    teams: "👥 Teams",
    teamsDesc: "Speel in teams – de host deelt spelers in",
    numTeams: "Aantal teams:",
    teamsLabel: "Teams:",
    chooseEmoji: "Kies emoji",
    startWith: "Starten met",
    teamsWord: "teams",
    gameCode: "Game Code",
    teamsModeLabel: "Teams modus",
    shareCode: "Deel deze code!",
    gameStarting: "Het spel begint zo...",
    shuffleTeams: "Willekeurig indelen",
    ...
    leaveGame: "Verlaat het spel",
    cancel: "Annuleren",
    leaveTitle: "Spel verlaten?",
    leaveHostDesc: "Als host wordt de hele room verwijderd en kunnen andere spelers niet meer verder spelen.",
    leavePlayerDesc: "Je verliest je voortgang als je nu het spel verlaat.",
    leave: "Verlaten",
    question: "Vraag",
