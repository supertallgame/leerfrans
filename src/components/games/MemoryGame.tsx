        ...
        {cards.map((card) => {
          ...
          return (
            <div
              ...
              className={`relative cursor-pointer transition-all duration-300 rounded-xl border-2 min-h-[80px] md:min-h-[100px] flex items-center justify-center p-2 md:p-3 text-center ${
                isMatched
