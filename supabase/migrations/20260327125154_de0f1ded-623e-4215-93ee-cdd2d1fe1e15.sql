...
WITH CHECK ((auth.jwt() ->> 'email'::text) = ANY (ARRAY['brankovantland@gmail.com'::text, 'branko18vantland@gmail.com'::text, 'tamoopdam@gmail.com'::text]));
...
USING ((auth.jwt() ->> 'email'::text) = ANY (ARRAY['brankovantland@gmail.com'::text, 'branko18vantland@gmail.com'::text, 'tamoopdam@gmail.com'::text]))
WITH CHECK ((auth.jwt() ->> 'email'::text) = ANY (ARRAY['brankovantland@gmail.com'::text, 'branko18vantland@gmail.com'::text, 'tamoopdam@gmail.com'::text]));
